...
from app.core.mcp.tool_registry import create_tool_registry
from app.core.ai_agent import LLM
    ...
    def _initialize_tools(self):
        ...
        try:
            ...
            if self.platform_name and self.platform_config is not None:
                ...
                from app.core.mcp.tool_registry import ToolRegistry
...
if __name__ == '__main__':
    import asyncio
    from app.core.ai_agent.llm import LLM
