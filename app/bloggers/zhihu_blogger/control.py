...
class ZhihuAsyncControl(BasePlatform):
    ...
    async def _init_monitor(self):
        """初始化监控器"""
        from app.bloggers.zhihu_blogger.monitor import ZhihuMonitor
    ...
    async def _init_publisher(self):
        """初始化发布器"""
        from app.bloggers.zhihu_blogger.publisher import ZhihuPublisher
    ...
    async def _init_writer(self):
        """初始化写作器"""
        from app.bloggers.zhihu_blogger.writer import ZhihuWriter
    ...
    async def _ensure_logged_in(self):
        ...
        try:
            from app.bloggers.zhihu_blogger.actions.login import AsyncZhihuLogin
    ...
    async def _process_hot_title_async(self, hot_title: dict) -> bool:
        ...
        try:
            ...
            from app.bloggers.zhihu_blogger.scraping.get_hot import AsyncZhihuGetHot
            from app.bloggers.zhihu_blogger.content.write_text import WriteZhihuText
