...
from app.bloggers.platform_enums import PlatformMode
...
class WeiboAsyncControl(BasePlatform):
    ...
    async def _init_monitor(self) -> None:
        """初始化监控器"""
        from app.bloggers.weibo_blogger.monitor import WeiboMonitor
    ...
    async def _init_publisher(self) -> None:
        """初始化发布器"""
        from app.bloggers.weibo_blogger.publisher import WeiboPublisher
    ...
    async def _init_writer(self) -> None:
        """初始化写作器"""
        from app.bloggers.weibo_blogger.writer import WeiboWriter
    ...
    async def _ensure_logged_in(self) -> None:
        ...
        try:
            from app.bloggers.weibo_blogger.actions.login import AsyncWeiboLogin
    ...
    async def _process_hot_title_async(self, hot_title: dict) -> bool:
        ...
        try:
            ...
            from app.bloggers.weibo_blogger.scraping.get_hot import AsyncWeiboGetHot
            from app.bloggers.weibo_blogger.content.write_text import WriteWeiboText
